...
constructs a requirement for demonstrated market interest that only the
EIC's prospective anchor participation can satisfy: a circular
validation in which the public actor's design constitutes the
conditions for the market signal it requires, while the Sovereignty Seal recurs across both instruments as
a portable legitimacy artefact that travels between funders.

% --- 6. Practical implications (1 sentence) -----------------------------------
The thesis offers practical implications for EIC programme design,
applicants, and policy makers concerned with the alignment of
mission-driven funding instruments.
