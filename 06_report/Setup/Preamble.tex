...
% --- Project additions (utility packages required by this thesis's content) --
\usepackage{enumitem}                                   % custom enumerate labels (SQ1, SQ2, ...)
\usepackage{longtable}                                  % multi-page appendix tables
\usepackage[colorinlistoftodos,textsize=small]{todonotes} % drafting markers
\newcommand{\todoinline}[1]{\todo[inline,color=yellow!40]{#1}}
% Switch the todonotes line to [disable] before final submission to suppress
% all \todoinline markers from the typeset output.
