...
the order. The point is reinforced by a within-corpus contrast.
Universal templating (Pattern~C, gender mainstreaming) and adaptive
entry (sustainability's four mechanisms, \cref{sec:res-sustainability})
