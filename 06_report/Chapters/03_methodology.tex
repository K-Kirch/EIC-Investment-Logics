...
The study is positioned as an initial probe of how the EU governs this
form of capital stimulus, not as a settled answer to it. A documentary
design can examine how the EIC inscribes its instruments and what
assumptions those inscriptions carry; it cannot, on its own, establish
how those textual commitments shape practice. Where the analysis
surfaces features that look consequential, the appropriate move is to
mark them as warranting further investigation. The reflexive grounds
for this framing are stated in \cref{sec:meth-reflexivity}.
...
My background shaped the study and should be stated. The thesis is
written at DTU and builds on more than four years of my own experience
in venture building, investing, and consulting. The work did not begin
from a neutral position. It began from a hypothesis: that the culture
of grants and non-dilutive funding in Europe shifts the actual
investment stage at which European companies take their first private
capital --- in some cases delaying that first capital by two years or
more. On this prior view, comparing a European seed-stage company to
a US seed-stage company is not a like-for-like comparison: the
European company has, in effect, been kept earlier on its trajectory
by the availability of public money.

I chose the object of analysis --- the EIC Pathfinder and STEP
instruments --- deliberately, with that hypothesis in mind. But what
the thesis actually examines is one step upstream of the hypothesis:
not whether the stage-shifting dynamic happens to firms in practice,
but how the EU governs the capital stimulus that, on the prior view,
would produce such a dynamic. The thesis should therefore be
understood as an initial probe of that governance question ---
whether the design of the EIC's grant and investment instruments
warrants closer attention --- rather than as a direct test of the
underlying hypothesis. A documentary design cannot establish whether
the stage-shift actually happens to firms; what it can do is examine
whether the institutional architecture that delivers the capital
stimulus exhibits textual features that merit further investigation.
The function of the thesis is therefore to indicate whether further
study of the governance of this kind of capital stimulus is
warranted. The investment-stage hypothesis itself, properly examined,
would require firm-level data and a different design, and is left for
a later study.

That alignment matters and should be acknowledged openly. The reading
the thesis lands on in Chapter~\ref{ch:discussion} --- that STEP is
best understood as a developmental-state instrument and that the EIC
constructs market signals as much as it responds to them --- points
in the same direction as the prior view that brought me to the topic.
The match is not in itself evidence of bias, but it is the obvious
risk to flag. Two safeguards were used. First, the
