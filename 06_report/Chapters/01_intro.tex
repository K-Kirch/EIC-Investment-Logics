...
\parencite{draghi2024future,letta2024much,ec2022jrcscoreboard}. In
...
capacity \parencite{mazzucato2013entrepreneurial}: the Union is catalysing
...
\parencite{mazzucato2013entrepreneurial}. The reading offered here moves in a
...
literatures \parencite{mazzucato2013entrepreneurial}, which supply the
...
\parencite{ec2025eicwp}, supplemented by the regulatory instruments
...
DARPA, Temasek and the Chinese Government Guidance Funds are supplied
by the developmental-state literature to characterise mission-oriented
design and are used in this thesis to read the EIC's instrument
architecture against a recognised comparator set. They are not named
in the Work Programme, are not treated as cases in their own right,
and are not subjected to the same close reading as the EIC text.
